...
if (typeof GetParentResourceName !== 'function') {
  ...
  const demoState = {
    ...
    temperature: 20,
    schedules: [
      { id: '1', hour: 8, minute: 0, weather: 'CLEAR', recurring: true },
      { id: '2', hour: 18, minute: 0, weather: 'RAIN', recurring: true }
    ],
    voteState: null,
    weatherTypes: [
  ...
  weatherOptions = demoState.weatherTypes;
  renderWeatherCards(demoState.weatherTypes, demoState.weather);
  renderWeatherSelect(demoState.weatherTypes);
  applyState(demoState, [
    { time: '15:42:50', actor: 'Admin', action: 'Weather', detail: 'Changed weather to CLEAR' },
    { time: '15:43:10', actor: 'Admin', action: 'Time', detail: 'Changed time to 12:00' }
  ]);
}
